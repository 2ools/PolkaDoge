...
contract Polkadoge is Context, IERC20, Ownable {
    ...
    uint256 public liquidityAddMaxGasPrice = 30 * 1000000000; //max gas price to execute the Liquidity swap

    ISwapRouter public swapRouter;
    INonfungiblePositionManager public nonfungiblePositionManager;

    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true; // Disable by default
    ...
    //change numTokensSellToAddToLiquidity
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 initialBalance = IERC20(nonfungiblePositionManager.WETH9()).balanceOf(address(this));

        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered

        // how much ETH did we just swap into?
        uint256 newBalance = IERC20(nonfungiblePositionManager.WETH9()).balanceOf(address(this)).sub(initialBalance);
